        ...
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                    ...
                    id="grid-first-name" name="firstname" type="text" placeholder="Ola">
            </div>
            <div class="md:w-1/2 px-3">
                ...
                <input
                    ...
                    id="grid-last-name" type="text" name="lastname" placeholder="Mide">
            </div>
        </div>
        ...
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-full px-3">
                ...
                <input
                    ...
                    id="grid-password" type="email" name="email" placeholder="email@mail.com">
            </div>
        </div>
