                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <a href="<?= ROOT ?>/schools/edit/<?= $row->id ?>" class="">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <a href="<?= ROOT ?>/schools/delete/<?= $row->id ?>" class="">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="dark:text-red-500"
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <a href="<?= ROOT ?>/switch_school/<?= $row->id ?>" class="">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-4 w-6 text-gray-600 font-extrabold" fill="none"
